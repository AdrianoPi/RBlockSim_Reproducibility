...
constexpr auto DATA = true;
constexpr auto NETWORK = true;
constexpr auto FLAG = 0; //0 for Bitcoin, 1 for Ethereum
constexpr auto PROPAGATION_POLICY = 0; //0 for CBR, 1 for Eth Wire
...
constexpr auto NODES_NUM = 100000;//11000;
constexpr auto BLOCK_INTERVAL = 13.0;//8;
...
constexpr auto TX_NUM = TX_PER_SEC * SIM_TIME;//TX_PER_SEC * SIM_TIME; // When DATA is disable, set TX_NUM to 1 to save memory
